@mod @mod_rplace
Feature: Basic operations with module Rplace
  In order to use Rplace in Moodle
  As a teacher and student
  I need to be able to modify and view Rplace
  ...
  @javascript
  Scenario: Viewing Rplace module and activities index page
    Given the following "activities" exist:
      | activity | name             | course | intro                   | section |
      | rplace   | Test module name | C1     | Test module description | 1       |
    ...
    And I am on "Course 1" course homepage
    And I click on "Rplaces" "link" in the "Activities" "block"
    And I should see "1" in the "Test module name" "table_row"

  @javascript
  Scenario: Creating and updating Rplace module
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    And I add a "Rplace" to section 1 using the activity chooser
